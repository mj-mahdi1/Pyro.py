...
Uv0 = 0.15    # Vitesse superficielle en m/s 
...
def odestiff(E, z):
    ...
    # Coefficient de transfert de chaleur fixé à 500 W/m²·K pour phase gaz
    h = 100  # Coefficient de transfert de chaleur interne
